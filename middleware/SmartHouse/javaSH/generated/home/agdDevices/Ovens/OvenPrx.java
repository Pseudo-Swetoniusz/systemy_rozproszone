...
public interface OvenPrx extends home.agdDevices.AGDPrx
{
    default void setProgram(Program p)
    {
        setProgram(p, com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default void setProgram(Program p, java.util.Map<String, String> context)
    {
        _iceI_setProgramAsync(p, context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Void> setProgramAsync(Program p)
    {
        return _iceI_setProgramAsync(p, com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Void> setProgramAsync(Program p, java.util.Map<String, String> context)
    {
        return _iceI_setProgramAsync(p, context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Void> _iceI_setProgramAsync(Program iceP_p, java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Void> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "setProgram", null, sync, null);
    ...
    default Program getProgram(java.util.Map<String, String> context)
    {
        return _iceI_getProgramAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<Program> getProgramAsync()
    {
        return _iceI_getProgramAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<Program> getProgramAsync(java.util.Map<String, String> context)
    {
        return _iceI_getProgramAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<Program> _iceI_getProgramAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<Program> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getProgram", null, sync, null);
