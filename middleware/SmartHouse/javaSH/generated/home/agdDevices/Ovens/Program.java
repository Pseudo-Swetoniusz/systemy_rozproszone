                                ...
                                java.io.Serializable
{
    ...
    public Program(Settings s, float duration, int temp)
    {
        this.s = s;
    ...
    {
        int h_ = 5381;
        h_ = com.zeroc.IceInternal.HashUtil.hashAdd(h_, "::home::agdDevices::Ovens::Program");
    ...
    {
        Settings.ice_write(ostr, this.s);
    ...
    /** @hidden */
    public static final long serialVersionUID = -917241250L;
}
