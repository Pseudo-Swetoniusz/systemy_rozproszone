...
public interface CameraPrx extends home.DevicePrx
{
    default View getView()
    {
        return getView(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default View getView(java.util.Map<String, String> context)
    {
        return _iceI_getViewAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<View> getViewAsync()
    {
        return _iceI_getViewAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<View> getViewAsync(java.util.Map<String, String> context)
    {
        return _iceI_getViewAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<View> _iceI_getViewAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<View> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getView", null, sync, null);
        f.invoke(true, context, null, null, istr -> {
                     View ret;
                     ret = View.ice_read(istr);
                     return ret;
                 });
        return f;
    }
