...
public interface DevicePrx extends com.zeroc.Ice.ObjectPrx
{
    ...
    {
        return getDeviceName(com.zeroc.Ice.ObjectPrx.noExplicitContext);
    }

    default String getDeviceName(java.util.Map<String, String> context)
    {
        return _iceI_getDeviceNameAsync(context, true).waitForResponse();
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getDeviceNameAsync()
    {
        return _iceI_getDeviceNameAsync(com.zeroc.Ice.ObjectPrx.noExplicitContext, false);
    }

    default java.util.concurrent.CompletableFuture<java.lang.String> getDeviceNameAsync(java.util.Map<String, String> context)
    {
        return _iceI_getDeviceNameAsync(context, false);
    }
     ...
     * @return -
     **/
    default com.zeroc.IceInternal.OutgoingAsync<java.lang.String> _iceI_getDeviceNameAsync(java.util.Map<String, String> context, boolean sync)
    {
        com.zeroc.IceInternal.OutgoingAsync<java.lang.String> f = new com.zeroc.IceInternal.OutgoingAsync<>(this, "getDeviceName", null, sync, null);
